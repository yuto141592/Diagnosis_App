...
#     # 画像のパスを入力
#     print_streaming("口の中の写真を送ってください:", delay=0.05, color=Fore.CYAN)
#     symptoms['image_path'] = input(">> ")
...
#     try:
#         # 体温の数値部分を抽出してfloatに変換
#         temperature_str = symptoms['temperature'].replace('℃', '').strip()
...
# # PDFの作成に画像を追加する関数
# def create_pdf(symptoms_summary, diagnosis_suggestions, image_path, medical_history):
#     pdf = FPDF()
#     pdf.add_page()
...
#     pdf.cell(0, 10, text=f"2021年 胃カメラ検査", new_x=XPos.LMARGIN, new_y=YPos.NEXT, align='L')
...
# def main():
#     # 患者の症状を入力
#     symptoms = ask_patient()

#     # これまでの受診歴および生体情報をあらかじめ設定
#     medical_history = "2021年 胃カメラ検査"
#     heart_rate = "75"  # 心拍数
#     steps = "600"      # 今日の歩数
...
#     # 診断候補を提案
#     diagnosis_suggestions = suggest_diagnosis(symptoms)

#     # PDFファイルの作成
#     pdf_path = create_pdf(symptoms_summary, diagnosis_suggestions, symptoms['image_path'], medical_history)
